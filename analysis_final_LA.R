...
namelist <- c("MathschoolsStuckNewOrleans.csv", "MathschoolsStuckDetailsNewOrleans.csv", 
              "MathproficiencyNewOrleans.csv", "MathgainsNewOrleans.csv",
              "MathTopBottomNewOrleans.csv", "MathBTONewOrleans.csv",
              "MathStuckExtraNewOrleans.csv")

##### 2nd RUN = READ - - - - - 
# data$subject <- data$read

# namelist <- c("ELAschoolsStuckNewOrleans.csv", "ELAschoolsStuckDetailsNewOrleans.csv", 
#              "ELAproficiencyNewOrleans.csv", "ELAgainsNewOrleans.csv",
#              "ELATopBottomNewOrleans.csv", "ELABTONewOrleans.csv",
#              "ELAStuckExtraNewOrleans.csv")
...
# namelist <- c("MathschoolsStuckBatonRouge.csv", "MathschoolsStuckDetailsBatonRouge.csv", 
#              "MathproficiencyBatonRouge.csv", "MathgainsBatonRouge.csv",
#              "MathTopBottomBatonRouge.csv", "MathBTOBatonRouge.csv",
#              "MathStuckExtraBatonRouge.csv")

##### 2nd RUN = READ - - - - - 
# data$subject <- data$read

# namelist <- c("ELAschoolsStuckBatonRouge.csv", "ELAschoolsStuckDetailsBatonRouge.csv", 
#              "ELAproficiencyBatonRouge.csv", "ELAgainsBatonRouge.csv",
#              "ELATopBottomBatonRouge.csv", "ELABTOBatonRouge.csv",
#              "ELAStuckExtraBatonRouge.csv")
...
equation <- subject.std ~ time + propfrl + propwhite + 
...
city_demo <- ddply(demo, c("schooltype", "city.new"), summarise,
                   ...
                   propfrl = mean(propfrl, na.rm = TRUE))

write.csv(city_demo, "NewOrleansDemograpic.csv")

hsdemo <- filter(demo, level == "3")
...
data <- filter(data, city == "Baton Rouge city")
colSums(data[,3:15], na.rm = TRUE)
math <- colMeans(data[,16:21], na.rm = TRUE)
write.csv(math, "MathEnrollmentBatonRouge.csv")
...
charter <- sum(filter(school_list, ischarter == "1")$enroll)/sum(school_list$enroll)
charter

write.csv(school_list, "SchoolListNewOrleans.csv")
# write.csv(school_list, "SchoolListBatonRouge.csv")

write.csv(charter, "CharterProportionNewOrleans.csv")
# write.csv(charter, "CharterProportionBatonRouge.csv")
